# Web3Auth Polymesh Example

This example demonstrates how to integrate Web3Auth into a React application for the Polymesh blockchain.
...
```bash
cd web3auth-pnp-examples/other/polymesh-example
```
