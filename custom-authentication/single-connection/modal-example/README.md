# Web3Auth Custom Authentication Modal Example

This example demonstrates how to implement custom authentication in the Web3Auth Modal.
...
```bash
cd web3auth-pnp-examples/custom-authentication/single-connection/modal-example
```
