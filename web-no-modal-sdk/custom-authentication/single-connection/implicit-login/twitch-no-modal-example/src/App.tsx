  ...
  const login = async () => {
    try {
      const web3authProvider = await web3auth.connectTo(WALLET_CONNECTORS.AUTH, {
        ...
        extraLoginOptions: {
          domain: "https://id.twitch.tv/oauth2/authorize",
          clientId: "ixn6jccs7lkwvl0wrgv3t6uvjkf85b", //use your app client id you got from twitch
        },
      });
  ...
  return (
    <div className="container">
      ...
      <footer className="footer">
        ...
        <a href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FWeb3Auth%2Fweb3auth-pnp-examples%2Ftree%2Fmain%2Fweb-no-modal-sdk%2Fcustom-authentication%2Fsingle-connection%2Fimplicit-login%2Ftwitch-no-modal-example&project-name=w3a-twitch-no-modal&repository-name=w3a-twitch-no-modal">
