# Web3Auth Cognito Implicit Example

This example demonstrates how to integrate Web3Auth with Amazon Cognito custom authentication.
...
```bash
cd web3auth-pnp-examples/custom-authentication/single-connection/cognito-implicit-example
```
