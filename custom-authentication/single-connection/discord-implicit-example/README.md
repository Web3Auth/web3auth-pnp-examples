# Web3Auth Discord Implicit Example

This example demonstrates how to integrate Web3Auth with Discord custom authentication.
...
```bash
cd web3auth-pnp-examples/custom-authentication/single-connection/discord-implicit-example
```
