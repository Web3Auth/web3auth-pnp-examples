      ...
      try {
        const web3auth = new Web3AuthCore({
          chainConfig: {
            ...
            chainId: "0x3",
            rpcTarget: "https://ropsten.infura.io/v3/0bb786dc49de43ce9b62a026c0297f9a",
          },
        });
  ...
  return (
    <div className="container">
      ...
      <footer className="footer">
        <a href="https://github.com/Web3Auth/examples/tree/master/google-core-react-example" target="_blank" rel="noopener noreferrer">
          Source code
        </a>
        <a href="https://faucet.egorfine.com/" target="_blank" rel="noopener noreferrer">
          Ropsten Faucet
        </a>
      </footer>
    </div>
