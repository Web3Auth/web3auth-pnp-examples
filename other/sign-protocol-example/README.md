# Web3Auth Sign Protocol Example

This example demonstrates how to integrate Web3Auth with Sign Protocol for secure message and transaction signing.
...
```bash
cd web3auth-pnp-examples/other/sign-protocol-example
```
