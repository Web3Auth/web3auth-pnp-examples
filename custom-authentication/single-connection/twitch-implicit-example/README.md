# Web3Auth Twitch Implicit Example

This example demonstrates how to integrate Web3Auth with Twitch custom authentication.
...
```bash
cd web3auth-pnp-examples/custom-authentication/single-connection/twitch-implicit-example
```
