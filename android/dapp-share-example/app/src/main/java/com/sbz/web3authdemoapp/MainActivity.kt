...
class MainActivity : AppCompatActivity() {
    ...
    private fun signIn() {
        val loginCompletableFuture: CompletableFuture<Web3AuthResponse> = web3Auth.login(LoginParams(selectedLoginProvider, mfaLevel = MFALevel.MANDATORY, dappShare = "afford join neutral spoon bike glue ahead floor giant match primary style cycle front address gossip embark rose boy muscle tuition melt left question" ))
        // store the dapp share in app memory and fetch it during the login.
