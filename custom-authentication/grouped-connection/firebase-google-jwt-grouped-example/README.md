# Web3Auth Firebase Google JWT Grouped Example

This example demonstrates how to integrate Web3Auth with Firebase Google JWT authentication in a grouped connection setup.
...
```bash
cd web3auth-pnp-examples/custom-authentication/grouped-connection/firebase-google-jwt-grouped-example
```
