# Web3Auth Auth0 Google JWT Grouped Example

This example demonstrates how to integrate Web3Auth with Auth0 Google JWT authentication in a grouped connection setup.
