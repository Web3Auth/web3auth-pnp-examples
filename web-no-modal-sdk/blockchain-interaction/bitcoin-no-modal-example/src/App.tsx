...
function App() {
  ...
  const loggedInView = (
    <div className="flex-container">
      ...
      {disconnectLoading && <Loading message="Disconnecting..." />}
  ...
  const unloggedInView = (
    <div className="grid">
      ...
      {connectLoading && <Loading message="Connecting..." />}
  ...
  return (
    <div className="container">
      ...
      <footer className="footer">
        <a
          href="https://github.com/Web3Auth/web3auth-pnp-examples/tree/main/web-no-modal-sdk/blockchain-interaction/bitcoin-no-modal-example"
          target="_blank"
