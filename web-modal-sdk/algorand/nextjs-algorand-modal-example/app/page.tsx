...
import RPC from "./algorandRPC"; // for using web3.js
  ...
  return (
    <div className="container">
      ...
      <footer className="footer">
        <a
          href="https://github.com/Web3Auth/examples/tree/main/web-modal-sdk/algorand/nextjs-algorand-modal-example"
          target="_blank"
