# Web3Auth Cosmos Example

This example demonstrates how to integrate Web3Auth into a React application for the Cosmos blockchain.
...
```bash
cd web3auth-pnp-examples/other/cosmos-example
```
