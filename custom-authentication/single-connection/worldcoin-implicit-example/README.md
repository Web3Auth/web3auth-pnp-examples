# Web3Auth Worldcoin Implicit Example

This example demonstrates how to integrate Web3Auth with Worldcoin custom authentication.
...
```bash
cd web3auth-pnp-examples/custom-authentication/single-connection/worldcoin-implicit-example
```
